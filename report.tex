...
\noindent\hspace{-0.5cm}\makebox[\linewidth]{\textcolor{svetlo-plava}{\rule{\paperwidth}{5pt}}}
	...
	\vspace{5mm}
	{\large \href{http://vaz.mas.bg.ac.rs}{\texttt{vaz.mas.bg.ac.rs}}} % Enter address
	\vspace*{\fill}
	\vfill

	{\large \textsc{Belgrade, 2026}} % Place and year
\end{titlepage}
...
\url{http://vaz.mas.bg.ac.rs}

\href{http://vaz.mas.bg.ac.rs}{Text with link to vaz.mas.bg.ac.rs}
